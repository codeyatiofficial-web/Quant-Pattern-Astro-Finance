...
const PLANS = [
    {
        ...
        features: ['1 Year Historical Data', 'All Core Analysis Tabs', 'Live Market Prices', 'Basic Astro Correlation'],
        cta: 'Current Plan',
        disabled: true,
    },
    {
        ...
        features: ['Up to 15 Years Historical Data', 'All Free Features', 'Pattern Backtesting', 'Astro VIX Correlation', 'Derivatives Strategy Tool', 'Priority Support'],
        cta: 'Upgrade to Pro',
        disabled: false,
        badge: 'Popular',
    },
    {
        ...
        features: ['Max 30+ Years Historical Data', 'All Pro Features', 'Astro Yoga Backtesting', '1-Month AI Forecast', 'Custom Alerts', 'Dedicated WhatsApp Support'],
